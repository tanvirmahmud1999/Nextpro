...
$header_padding =  $enable_topbar;
if (!is_user_logged_in()) {
  $header_padding =  $enable_topbar ? '' : 'pt-4 ';
}
// offcanvas_menu
...
// tra_header
$tra_header = get_theme_mod('tra_header', true);
$tra_header = nextpro_get_post_meta('tra_header', true);
...
$navbar_style = $navbar_style == 'section-header--five' ? 'section-header--five' : '';

$padding = $navbar_style == 'section-header--five' ? '' : 'ps-4 pe-4';
?>
<div class="header-wrapper <?php echo esc_attr($tra_menu) ?>">
  ...
  <header id="header" <?php nextpro_header_class(' ' . $sticky_class . ' ' . $header_padding . '' . $navbar_style . ''); ?>>
    <div class="header-wrapper container-fluid m-auto bg-transparent position-relative">
      <div class="section-header__inner">
        <div class="section-header__row <?php echo esc_attr($padding) ?> d-flex flex-wrap align-items-center justify-content-between">

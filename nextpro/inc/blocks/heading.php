 ...
 */
function nextpro_block_core_heading_render($attributes, $content)
{
	if (!$content) {
		return $content;
	}
 ...
 */
function nextpro_register_block_core_heading()
{
	register_block_type_from_metadata(
		ABSPATH . 'wp-includes/blocks/heading',
		array(
			'render_callback' => 'nextpro_block_core_heading_render',
		)
	);
}

add_action('init', 'nextpro_register_block_core_heading');
